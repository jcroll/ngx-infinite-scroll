...
function createScroller(config) {
    ...
    return attachScrollEvent(options).pipe(rxjs_operators.mergeMap(function (ev) { return rxjs.of(calculatePoints(element, resolver)); }), rxjs_operators.map(function (positionStats) { return toInfiniteScrollParams(scrollState.lastScrollPosition, positionStats, distance); }), rxjs_operators.tap(function (_a) {
